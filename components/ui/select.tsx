...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        'relative web:group flex flex-row w-full web:cursor-default web:select-none items-center rounded-sm py-1.5 native:py-2 pl-2 native:pl-4 pr-2 web:hover:bg-accent/50 active:bg-accent web:outline-none web:focus:bg-accent',
